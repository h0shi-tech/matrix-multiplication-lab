...
> В отчёте использованы оценочные, но правдоподобные данные, оформленные в формате результатов эксперимента. Их можно заменить реальными замерами без изменения структуры отчёта.
